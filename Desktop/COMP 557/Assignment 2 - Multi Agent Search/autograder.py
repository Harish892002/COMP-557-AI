...
if __name__ == '__main__':
    ...
    if options.runTest != None:
        ...
        for question in ['q1', 'q2', 'q3', 'q4', 'q5']:
            max_score = dict_max_score[question]
            max_score_ratio = dict_max_score_ratio[question]
            # if question == 'q4' or question == 'q6':
            #     score = grades.points[question]
            # else:
            score = max_score_ratio * points[question]
            dict_output["tests"].append({"name": question, "max_score": max_score, "score": score})
